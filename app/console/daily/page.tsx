...
export default async function DailyChallengesPage({
  ...
  const games = [
    {
      key: "syntax-puzzle",
      title: "Syntax Puzzle Daily",
      description: "Solve 5 syntax puzzles in under 10 minutes",
      path: "/games/syntax-puzzle",
      baseXP: 25,
      baseDiamonds: 15,
      difficulty: 1,
    },
    {
      key: "code-match",
      title: "Code Match Daily",
      description: "Match code to output — 5 rounds",
      path: "/games/code-match",
      baseXP: 25,
      baseDiamonds: 15,
      difficulty: 1,
    },
    {
      key: "variable-naming",
      title: "Variable Naming Daily",
      description: "Name variables correctly 5 times",
      path: "/games/variable-naming",
      baseXP: 25,
      baseDiamonds: 15,
      difficulty: 1,
    },
    {
      key: "data-types",
      title: "Data Types Daily",
      description: "Identify correct Python data types — 5 questions",
      path: "/games/data-types",
      baseXP: 25,
      baseDiamonds: 15,
      difficulty: 1,
    },
    {
      key: "loop-runner",
      title: "Loop Runner Daily",
      description: "Predict loop outputs — 5 rounds",
      path: "/games/loop-runner",
      baseXP: 25,
      baseDiamonds: 15,
      difficulty: 1,
    },
    {
      key: "function-calls",
      title: "Function Calls Daily",
      description: "Predict function call outputs — 5 rounds",
      path: "/games/function-calls",
      baseXP: 25,
      baseDiamonds: 15,
      difficulty: 1,
    },
  ...
  const existingToday = await prisma.dailyMiniQuiz.findFirst({
    where: { date: { gte: todayStart, lte: todayEnd }, title: pick.title },
  });
  if (!existingToday) {
    try {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="rounded-xl border overflow-hidden shadow-sm">
        <div className="bg-gradient-to-r from-emerald-600/90 via-teal-600/90 to-green-600/90 text-white px-4 py-3">
      ...
      <div className="rounded-xl border overflow-hidden shadow-sm">
        <div className="bg-gradient-to-r from-violet-600/90 via-purple-600/90 to-fuchsia-600/90 text-white px-4 py-3">
          <div className="flex items-center justify-between">
          ...
          <tbody>
            {items.map((d, idx) => (
              <tr
                ...
                className={
                  idx % 2
                    ? "bg-gradient-to-r from-violet-50/30 to-purple-50/30"
                    : "bg-gradient-to-r from-purple-50/50 to-fuchsia-50/50 hover:bg-gradient-to-r hover:from-violet-100/60 hover:to-purple-100/60 transition-colors"
                }
              >
      ...
      <div className="flex items-center justify-between text-sm">
        ...
        <div className="flex items-center gap-2">
          <a
            ...
            href={`?page=${Math.max(1, page - 1)}&size=${size}`}
          >
            Prev
          </a>
          <span>
          ...
          <a
            className="rounded border px-2 py-1"
            href={`?page=${Math.min(totalPages, page + 1)}&size=${size}`}
          >
            Next
          </a>
        </div>
